    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (inputs, targets) in enumerate(trainloader):
            ...
            if iteration == start_iteration:
                ...
                #loss1 = nn.KLDivLoss()(F.log_softmax(outputs[:,:ref_outputs.shape[-1]]/2., dim=1), F.softmax(ref_outputs.detach()/2., dim=1)) * ref_outputs.shape[-1]#gfk.fit(ref_features.detach(), cur_features) * lamda
                #loss1 = gfk.fit(ref_features.detach(), cur_features) * lamda#/1.
        ...
        # else:
        #     print('[LF] Train set: {}, Train Loss1: {:.4f}, Train Loss2: {:.4f},\
