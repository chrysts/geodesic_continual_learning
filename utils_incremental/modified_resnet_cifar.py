...
import utils_incremental.modified_linear as modified_linear
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10):
        ...
        self.fc = modified_linear.CosineLinear(64 * block.expansion, num_classes) ## EDITED 4
    ...
    def forward(self, x, is_feature=False):
        ...
        #     feature_out = F.adaptive_avg_pool2d(x3, 2)
        #     return feature_out.view(feature_out.size(0), -1), self.fc(out)
